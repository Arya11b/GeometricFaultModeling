...
//    igl::read_triangle_mesh( "./models/bunny.obj", V, F);
//    v.data().set_mesh(V,F);
...
//float lighting_factor2 =0.0;
//if(lighting_factor < 0.8) lighting_factor2 = 0.0;
//else lighting_factor2 = 0.8;
//vec4 color = vec4(lighting_factor2 * (If + Is + Id) + Ia +
//  (1.0-lighting_factor2) * vec3(Kdi),(Kai.a+Ksi.a+Kdi.a)/3);
//
